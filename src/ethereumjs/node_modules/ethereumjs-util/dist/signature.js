...
// const randombytes = require("ethereum-cryptography/random"); // 这里修改了
const crypto = require('crypto');
function ecsign(msgHash, privateKey, chainId) {

    // const { signature, recid: recovery } = (0, secp256k1_1.ecdsaSign)(msgHash, privateKey);
    const { signature, recid: recovery } = (0, secp256k1_1.ecdsaSign)(msgHash, privateKey, {data:crypto.randomBytes(32)}); // 这里是修改的！！！
